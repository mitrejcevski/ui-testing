...
infix fun Int.hasHint(@StringRes resource: Int): ViewAssertion = onView(withId(this)) hasHint resource

infix fun Int.hasText(@StringRes resource: Int): ViewAssertion = onView(withId(this)) hasText resource